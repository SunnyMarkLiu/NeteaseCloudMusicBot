...
class Song(object):
    ...
    def create_img(self, pic_style):
        if pic_style == 1:
            Img(self.id).save(self.song_name, self.song_lrc, self.song_img)
        elif pic_style == 2:
            Img(self.id).save2(self.song_name, self.song_lrc, self.song_img)
        elif pic_style == 3:
            Img(self.id).save3(self.song_name, self.song_lrc, self.song_img)


class Img():

    def __init__(self, id, save_dir=None):
        self.id = id
        self.save_dir = save_dir

        self.font_family = 'res/STHeiti-Light.ttc'
        ...
        self.netease_banner = u'Powered by Wechaty & SunnyMarkLiu'
    ...
    def save(self, name, lrc, img_url):
        ...
        out_img.save(img_save_path + self.id + '.png')
